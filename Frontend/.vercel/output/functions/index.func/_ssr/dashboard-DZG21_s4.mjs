...
import { n as Users, b as Building2, T as Ticket, I as IndianRupee } from "../_libs/lucide-react.mjs";
...
function AdminDash() {
  ...
  reactExports.useEffect(() => {
    (async () => {
      try {
        const {
          data
        } = await api.get("/admin/platform-stats");
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-[#F5F3EE]", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(PageHeader, { eyebrow: "Platform overview", title: "Admin Dashboard", subtitle: "Platform-wide stats." }),
...
const SplitComponent = () => /* @__PURE__ */ jsxRuntimeExports.jsx(ProtectedRoute, { roles: ["admin"], children: /* @__PURE__ */ jsxRuntimeExports.jsx(AdminDash, {}) });
export {
